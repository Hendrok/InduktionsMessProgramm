...
void PpmsWidget::newData(std::shared_ptr<const DataPoint> dpoint)
{
    if(dpoint != nullptr){
        ...
        std::string datastring = dpoint->ppmsdata()->pvStatusPpms();
        for (unsigned long i = 0; i < datastring.size(); i++) {
                    if (datastring.at(i) == ',') { comma_counter++; } }
        ...
        */
        if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 0) { tempStatus_->setText("Status unknown");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 1) { tempStatus_->setText("Stable");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 2) { tempStatus_->setText("Tracking");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 3) { tempStatus_->setText("Reserved");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 4) { tempStatus_->setText("Reserved");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 5) { tempStatus_->setText("Near");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 6) { tempStatus_->setText("Chasing");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 7) { tempStatus_->setText("Filling/Emptying reservoir");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 8) { tempStatus_->setText("Reserved");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 9) { tempStatus_->setText("Reserved");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 10) { tempStatus_->setText("Stand By Mode");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 11) { tempStatus_->setText("Reserved");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 12) { tempStatus_->setText("Reserved");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 13) { tempStatus_->setText("temperature Control disabled");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 14) { tempStatus_->setText("Impedance not functioning");}
        else if ((static_cast<int>(Datavector.at(2)) & 0b1111) == 15) { tempStatus_->setText("General Failure");}
        //Feld-Stati
        if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 0) { magStatus_->setText("Status unknown");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 1) { magStatus_->setText("Persistent mode, stable");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 2) { magStatus_->setText("Persist mode switch warming");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 3) { magStatus_->setText("Persist mode switch cooling");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 4) { magStatus_->setText("Driven mode, stable at final field");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 5) { magStatus_->setText("Driven mode, final approach");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 6) { magStatus_->setText("Charging magnet at specified voltage");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 7) { magStatus_->setText("Discharging magnet");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 8) { magStatus_->setText("Current error, incorrect current in magnet");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 9) { magStatus_->setText("Reserved");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 10) { magStatus_->setText("Reserved");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 11) { magStatus_->setText("Reserved");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 12) { magStatus_->setText("Reserved");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 13) { magStatus_->setText("Reserved");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 14) { magStatus_->setText("Reserved");}
        else if (((static_cast<int>(Datavector.at(2)) >> 4) & 0b1111) == 15) { magStatus_->setText("General failure in magnet control system");}
        //Chamber-Stati
        if (((static_cast<int>(Datavector.at(2)) >> 8) & 0b1111) == 0) { chamberStatus_->setText("Status unknown");}
        else if (((static_cast<int>(Datavector.at(2)) >> 8) & 0b1111) == 1) { chamberStatus_->setText("Purged and sealed");}
        else if (((static_cast<int>(Datavector.at(2)) >> 8) & 0b1111) == 2) { chamberStatus_->setText("Vented and sealed");}
        else if (((static_cast<int>(Datavector.at(2)) >> 8) & 0b1111) == 3) { chamberStatus_->setText("Sealed, condition unknown");}
        else if (((static_cast<int>(Datavector.at(2)) >> 8) & 0b1111) == 4) { chamberStatus_->setText("Performing purge/seal routine");}
        else if (((static_cast<int>(Datavector.at(2)) >> 8) & 0b1111) == 5) { chamberStatus_->setText("Performing vent/seal sequence");}
        else if (((static_cast<int>(Datavector.at(2)) >> 8) & 0b1111) == 6) { chamberStatus_->setText("Reserved");}
        else if (((static_cast<int>(Datavector.at(2)) >> 8) & 0b1111) == 7) { chamberStatus_->setText("Reserved");}
        else if (((static_cast<int>(Datavector.at(2)) >> 8) & 0b1111) == 8) { chamberStatus_->setText("Pumping continuously");}
        else if (((static_cast<int>(Datavector.at(2)) >> 8) & 0b1111) == 9) { chamberStatus_->setText("Flooding continuously");}
        else if (((static_cast<int>(Datavector.at(2)) >> 8) & 0b1111) == 15) { chamberStatus_->setText("General failure in gas control System");}
        //angle
        if (((static_cast<int>(Datavector.at(2)) >> 12) & 0b1111) == 0) { rotStatus_->setText("Status unknown");}
        else if (((static_cast<int>(Datavector.at(2)) >> 12) & 0b1111) == 1) { rotStatus_->setText("Sample stopped at target value");}
        else if (((static_cast<int>(Datavector.at(2)) >> 12) & 0b1111) == 5) { rotStatus_->setText("Sample moving toward set point");}
        else if (((static_cast<int>(Datavector.at(2)) >> 12) & 0b1111) == 6) { rotStatus_->setText("Reserved");}
        else if (((static_cast<int>(Datavector.at(2)) >> 12) & 0b1111) == 7) { rotStatus_->setText("Reserved");}
        else if (((static_cast<int>(Datavector.at(2)) >> 12) & 0b1111) == 8) { rotStatus_->setText("Sample hit limit switch");}
        else if (((static_cast<int>(Datavector.at(2)) >> 12) & 0b1111) == 9) { rotStatus_->setText("Sample hit index switch");}
        else if (((static_cast<int>(Datavector.at(2)) >> 12) & 0b1111) == 15) { rotStatus_->setText("General failure ");}
